# Sonar Trading MCP Server

This MCP (Model Content Protocol) server provides access to Sonar Trading API functionality through HTTP, HTTPS, and STDIO transport modes.
